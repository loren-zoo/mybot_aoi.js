...
$channelsendmessage[$channelID;Le rôle \`$roleName[$get[role]]\` a été retiré à **$usertag[$get[membre]]**]
$takeRole[$guildID;$get[membre];$get[role]]
$onlyIf[$rolePosition[$highestRole[$clientID];$guildID]<$rolePosition[$findRole[$message[2]];$guildID];Je n'ai pas la permission de retiré ce rôle]
